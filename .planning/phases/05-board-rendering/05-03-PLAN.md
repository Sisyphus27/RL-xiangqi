...
**4. `tests/ui/test_board_items.py`:**
```python
...
Use conda env `xqrl` for any Python commands. Run tests with: `conda activate xqrl && python -m pytest tests/ui/ -v`
  ...
  <done>tests/ui/ package with conftest.py, test_constants.py, test_board_items.py, test_board.py — all tests green</done>
</task>
